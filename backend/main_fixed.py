...
from rag_fixed import rag_service, RAGQuery, SelectedTextQuery, RAGResponse  # Using the fixed version
...
# Add CORS middleware
origins_str = os.getenv("BACKEND_CORS_ORIGINS", '["http://localhost:3000", "http://localhost:3001", "https://your-frontend-domain.com"]')
try:
    import json
...
async def ingest_document(request: IngestRequest):
    ...
    try:
        ...
        # Actually perform the ingestion using qdrant_manager
